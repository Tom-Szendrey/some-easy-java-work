 ...
 *Tom Szendrey 10187030 14TJS5, Assignment 1, pig game
 */
public class Assn1_14TJS5 {
	...
	public static void playerTurn(int turnScore, int[] scores){
		...
		if (scores[0] + turnScore >= 100 & dieVals[0] != 1 & dieVals[1] != 1){
			scores[0] = scoreUpdate(turnScore,scores[0]);
			System.out.println("You have won! /n Your final score was: " + scores[0]);
			System.exit(10); 
	...
	public static void computerTurn(int turnScore, int[] scores) {	
		...
		if (scores[1] + turnScore >= 100 & dieVals[0] != 1 & dieVals[1] != 1){
			scores[1] = scoreUpdate(turnScore, scores[1]); 
			System.out.println("The computer has beaten you with a score of: " + scores[1]);
			System.exit(10);
		}//ends the check to see if computer won game
